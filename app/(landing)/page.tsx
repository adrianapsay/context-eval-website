            ...
            <section className="bg-white dark:bg-gray-950 py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        <Link href="/project-artifacts/paper.pdf" target="_blank" rel="noopener noreferrer">
                        ...
                        <Link href="/project-artifacts/poster.pdf" target="_blank" rel="noopener noreferrer">
                            <Button className="rounded-full bg-gray-900 text-white hover:bg-gray-800 px-5 py-2 text-sm gap-2">
